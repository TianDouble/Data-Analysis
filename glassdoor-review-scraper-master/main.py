...
def go_to_next_page():
    ...
    #paging_control = browser.find_element_by_class_name('pagingControls')
    paging_control = browser.find_element_by_css_selector('.eiReviews__EIReviewsPageContainerStyles__pagination.noTabover.mt')
    next_ = paging_control.find_element_by_class_name('pagination__PaginationStyle__next').find_element_by_tag_name('a')
    #next_ = paging_control.find_element_by_class_name('next').find_element_by_tag_name('a')
...
def get_browser():
    ...
    chrome_options = "/Users/txyfile/Desktop/143_project/glassdoor-review-scraper-master/chromedriver.exe"
    if args.headless:
        chrome_options.add_argument('--headless')
    #chrome_options.add_argument('log-level=3')
    #browser = wd.Chrome(options=chrome_options)
    browser = wd.Chrome(chrome_options)
    return browser
...
def main():
    ...
    #ylogger.info(f'Finished in {end - start} seconds')
